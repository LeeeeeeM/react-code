<<<<<<< 10f5df0206a209378edb0e2fb3e2d72e96489845
// 必须这么写，这样保证每个js文件内部的执行顺序
import './install'
import './router'
=======
...
React.createElement = function () {
  return originCreateElement.apply(React, arguments)
}
  ...
  render() {
    ...
    return (
      <div className="container">
        {
          this.state.show ? (<div onClick={this.add.bind(this)}>{this.state.count}</div>) : (<div onClick={this.add.bind(this)}>{this.state.count}{ "x" }</div>)
        }
